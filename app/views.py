...
class HomeView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['categories'] = [
            {'name': 'Mercearia'}, {'name': 'Frutas'}, {'name': 'Saladas'},
        ...
        try:
            ...
            messages.warning(self.request, f"Erro ao carregar todos os produtos da API para ofertas: {error}")
        ...
        try:
            ...
            messages.error(self.request, f"Erro ao carregar produtos da API externa para exibição principal: {error}")
