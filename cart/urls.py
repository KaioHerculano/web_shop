...
urlpatterns = [
    ...
    path('cart/update/<str:product_id>/', views.UpdateCartItemView.as_view(), name='update_cart_item'),
    path('add-api-to-cart/<str:product_id>/', views.AddApiProductToCartView.as_view(), name='add_api_product_to_cart'),
]
